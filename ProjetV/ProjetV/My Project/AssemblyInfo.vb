...
<Assembly: AssemblyTitle("l'application de creation de compte")>
<Assembly: AssemblyDescription("*****L'application permet de créer des comptes pour les stagiaires de l'ENI. Elle est connecter à une infrastructure de fédération d'itentité, reliée à plusieurs API, pour y faire la liaison vers plusieurs applications.*****")>
<Assembly: AssemblyCompany("ENI")>
<Assembly: AssemblyProduct("")>
<Assembly: AssemblyCopyright("Copyright ©  2017 - GNU GPL")>
<Assembly: AssemblyTrademark("By V Group - MS2I IN 6")>
...
<Assembly: Guid("ad105a10-a903-476e-a0d9-0814d455939f")>
